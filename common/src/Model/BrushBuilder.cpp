...
namespace TrenchBroom {
    namespace Model {
        ...
        Brush BrushBuilder::createCube_(const FloatType size, const std::string& textureName) const {
            return createCuboid_(vm::bbox3(size / 2.0), textureName, textureName, textureName, textureName, textureName, textureName);
        }

        Brush BrushBuilder::createCube_(FloatType size, const std::string& leftTexture, const std::string& rightTexture, const std::string& frontTexture, const std::string& backTexture, const std::string& topTexture, const std::string& bottomTexture) const {
            return createCuboid_(vm::bbox3(size / 2.0), leftTexture, rightTexture, frontTexture, backTexture, topTexture, bottomTexture);
        }
        
        Brush BrushBuilder::createCuboid_(const vm::vec3& size, const std::string& textureName) const {
            return createCuboid_(vm::bbox3(-size / 2.0, size / 2.0), textureName, textureName, textureName, textureName, textureName, textureName);
        }

        Brush BrushBuilder::createCuboid_(const vm::vec3& size, const std::string& leftTexture, const std::string& rightTexture, const std::string& frontTexture, const std::string& backTexture, const std::string& topTexture, const std::string& bottomTexture) const {
            return createCuboid_(vm::bbox3(-size / 2.0, size / 2.0), leftTexture, rightTexture, frontTexture, backTexture, topTexture, bottomTexture);
        }

        Brush BrushBuilder::createCuboid_(const vm::bbox3& bounds, const std::string& textureName) const {
            return createCuboid_(bounds, textureName, textureName, textureName, textureName, textureName, textureName);
        }

        Brush BrushBuilder::createCuboid_(const vm::bbox3& bounds, const std::string& leftTexture, const std::string& rightTexture, const std::string& frontTexture, const std::string& backTexture, const std::string& topTexture, const std::string& bottomTexture) const {
        ...
        Brush BrushBuilder::createBrush_(const std::vector<vm::vec3>& points, const std::string& textureName) const {
            return createBrush_(Polyhedron3(points), textureName);
        }

        Brush BrushBuilder::createBrush_(const Polyhedron3& polyhedron, const std::string& textureName) const {
