...
namespace TrenchBroom {
    namespace Model {
        ...
        TEST(BrushNodeTest, constructBrushWithRedundantFaces) {
        ...
        TEST(BrushNodeTest, constructBrushWithFaces) {
            const vm::bbox3 worldBounds(4096.0);
        ...
        TEST(BrushNodeTest, constructWithFailingFaces) {
            /* from rtz_q1
             {
        ...
        TEST(BrushNodeTest, constructWithFailingFaces2) {
            /* from ne_ruins
             {
        ...
        TEST(BrushNodeTest, constructWithFailingFaces3) {
            /* from ne_ruins
             {
        ...
        TEST(BrushNodeTest, constructWithFailingFaces4) {
            /* from ne_ruins
             {
        ...
        TEST(BrushNodeTest, constructWithFailingFaces5) {
        ...
        TEST(BrushNodeTest, constructWithFailingFaces6) {
            /* from 768_negke
             {
        ...
        TEST(BrushNodeTest, constructBrushWithManySides) {
            /*
        ...
        TEST(BrushNodeTest, constructBrushAfterRotateFail) {
            /*
        ...
        TEST(BrushNodeTest, buildBrushFail) {
            /*
        ...
        TEST(BrushNodeTest, buildBrushFail2) {
            /*
        ...
        TEST(BrushNodeTest, buildBrushFail3) {
        ...
        TEST(BrushNodeTest, buildBrushWithShortEdges) {
            /*
        ...
        TEST(BrushNodeTest, partialSelectionAfterAdd) {
            const vm::bbox3 worldBounds(4096.0);
        ...
        TEST(BrushNodeTest, partialSelectionBeforeAdd) {
            const vm::bbox3 worldBounds(4096.0);
        ...
        TEST(BrushNodeTest, moveBoundary) {
            const vm::bbox3 worldBounds(4096.0);
        ...
        TEST(BrushNodeTest, moveTetrahedronVertexToOpposideSide) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, moveFaceDownFailure) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, movePointRemainingPolygon) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, movePointRemainingPolyhedron) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, moveEdgeRemainingPolyhedron) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, moveEdgesRemainingPolyhedron) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, movePolygonRemainingPoint) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, movePolygonRemainingEdge) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, movePolygonRemainingPolygon) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, movePolygonRemainingPolygon2) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, movePolygonRemainingPolygon_DisallowVertexCombining) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, movePolygonRemainingPolyhedron) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, moveTwoFaces) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, movePolyhedronRemainingEdge) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, moveFaceFailure) {
        ...
        TEST(BrushNodeTest, moveVertexFail) {
            const std::string data("{\n"
        ...
        TEST(BrushNodeTest, moveVertexInwardWithoutMerges) {
        ...
        TEST(BrushNodeTest, moveVertexOutwardWithoutMerges) {
            const vm::vec3d p1(-64.0, -64.0, -64.0);
            const vm::vec3d p2(-64.0, -64.0, +64.0);
            const vm::vec3d p3(-64.0, +64.0, -64.0);
            const vm::vec3d p4(-64.0, +64.0, +64.0);
        ...
        TEST(BrushNodeTest, moveVertexWithOneOuterNeighbourMerge) {
            const vm::vec3d p1(-64.0, -64.0, -64.0);
            const vm::vec3d p2(-64.0, -64.0, +64.0);
            const vm::vec3d p3(-64.0, +64.0, -64.0);
            const vm::vec3d p4(-64.0, +64.0, +64.0);
        ...
        TEST(BrushNodeTest, moveVertexWithTwoOuterNeighbourMerges) {
            const vm::vec3d p1(-64.0, -64.0, -64.0);
            const vm::vec3d p2(-64.0, -64.0, +64.0);
            const vm::vec3d p3(-64.0, +64.0, -64.0);
            const vm::vec3d p4(-64.0, +64.0, +64.0);
        ...
        TEST(BrushNodeTest, moveVertexWithAllOuterNeighbourMerges) {
            const vm::vec3d p1(-64.0, -64.0, -64.0);
            const vm::vec3d p2(-64.0, -64.0, +64.0);
            const vm::vec3d p3(-64.0, +64.0, -64.0);
            const vm::vec3d p4(-64.0, +64.0, +64.0);
        ...
        TEST(BrushNodeTest, moveVertexWithAllInnerNeighbourMerge) {
            const vm::vec3d p1(-64.0, -64.0, -64.0);
            const vm::vec3d p2(-64.0, -64.0, +64.0);
            const vm::vec3d p3(-64.0, +64.0, -64.0);
            const vm::vec3d p4(-64.0, +64.0, +64.0);
        ...
        TEST(BrushNodeTest, moveVertexUpThroughPlane) {
            const vm::vec3d p1(-64.0, -64.0, -64.0);
            const vm::vec3d p2(-64.0, -64.0, +64.0);
            const vm::vec3d p3(-64.0, +64.0, -64.0);
            const vm::vec3d p4(-64.0, +64.0, +64.0);
        ...
        TEST(BrushNodeTest, moveVertexOntoEdge) {
            const vm::vec3d p1(-64.0, -64.0, -64.0);
            const vm::vec3d p2(-64.0, -64.0, +64.0);
            const vm::vec3d p3(-64.0, +64.0, -64.0);
            const vm::vec3d p4(-64.0, +64.0, +64.0);
        ...
        TEST(BrushNodeTest, moveVertexOntoIncidentVertex) {
            const vm::vec3d p1(-64.0, -64.0, -64.0);
            const vm::vec3d p2(-64.0, -64.0, +64.0);
            const vm::vec3d p3(-64.0, +64.0, -64.0);
            const vm::vec3d p4(-64.0, +64.0, +64.0);
        ...
        TEST(BrushNodeTest, moveVertexOntoIncidentVertexInOppositeDirection) {
            const vm::vec3d p1(-64.0, -64.0, -64.0);
            const vm::vec3d p2(-64.0, -64.0, +64.0);
            const vm::vec3d p3(-64.0, +64.0, -64.0);
            const vm::vec3d p4(-64.0, +64.0, +64.0);
        ...
        TEST(BrushNodeTest, moveVertexAndMergeColinearEdgesWithoutDeletingVertex) {
            const vm::vec3d p1(-64.0, -64.0, -64.0);
            const vm::vec3d p2(-64.0, -64.0, +64.0);
            const vm::vec3d p3(-64.0, +64.0, -64.0);
            const vm::vec3d p4(-64.0, +64.0, +64.0);
        ...
        TEST(BrushNodeTest, moveVertexAndMergeColinearEdgesWithoutDeletingVertex2) {
            const vm::vec3d p1(-64.0, -64.0, -64.0);
            const vm::vec3d p2(-64.0, -64.0, +64.0);
            const vm::vec3d p3(-64.0, +64.0, -64.0);
            const vm::vec3d p4(-64.0, +64.0, +64.0);
        ...
        TEST(BrushNodeTest, moveVertexAndMergeColinearEdgesWithDeletingVertex) {
            const vm::vec3d p1(-64.0, -64.0, -64.0);
            const vm::vec3d p2(-64.0, -64.0, +64.0);
            const vm::vec3d p3(-64.0, +64.0, -64.0);
            const vm::vec3d p4(-64.0, +64.0, +64.0);
        ...
        TEST(BrushNodeTest, moveVertexFailing1) {
        ...
        TEST(BrushNodeTest, subtractCuboidFromCuboid) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, subtractDisjoint) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, subtractEnclosed) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, subtractTruncatedCones) {
        ...
        TEST(BrushNodeTest, subtractDome) {
        ...
        TEST(BrushNodeTest, subtractPipeFromCubeWithMissingFragments) {
        ...
        TEST(BrushNodeTest, testAlmostDegenerateBrush) {
        ...
        TEST(BrushNodeTest, snapIssue1198) {
        ...
        TEST(BrushNodeTest, snapIssue1202) {
        ...
        TEST(BrushNodeTest, snapIssue1203) {
        ...
        TEST(BrushNodeTest, snapIssue1205) {
        ...
        TEST(BrushNodeTest, snapIssue1206) {
        ...
        TEST(BrushNodeTest, snapIssue1207) {
        ...
        TEST(BrushNodeTest, snapIssue1232) {
        ...
        TEST(BrushNodeTest, snapIssue1395_24202) {
        ...
        TEST(BrushNodeTest, snapIssue1395_18995) {
            // https://github.com/kduske/TrenchBroom/issues/1395 brush at line 24202
            const std::string data("{\n"
        ...
        TEST(BrushNodeTest, invalidBrush1332) {
        ...
        TEST(BrushNodeTest, invalidBrush1395) {
        ...
        TEST(BrushNodeTest, invalidBrush1801) {
        ...
        TEST(BrushNodeTest, snapToGrid64) {
        ...
        TEST(BrushNodeTest, removeSingleVertex) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, removeMultipleVertices) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);
            BrushBuilder builder(&world, worldBounds);
        ...
        TEST(BrushNodeTest, snapshotTextureTest) {
            const vm::bbox3 worldBounds(8192.0);
            WorldNode world(MapFormat::Standard);
        ...
        TEST(BrushNodeTest, resizePastWorldBounds) {
            const vm::bbox3 worldBounds(8192.0);
            WorldNode world(MapFormat::Standard);
            const BrushBuilder builder(&world, worldBounds);
        ...
        TEST(BrushNodeTest, moveVerticesPastWorldBounds) {
            const vm::bbox3 worldBounds(8192.0);
            WorldNode world(MapFormat::Standard);
            const BrushBuilder builder(&world, worldBounds);
        ...
        TEST(BrushNodeTest, intersectsIssue1893) {
            const std::string data("{\n"
        ...
        TEST(BrushNodeTest, removeVertexWithCorrectTextures) {
...
( 1199.73437537143649934 -1850.52292721460958091 299.11555748386712139 ) ( 1195.3323608207340385 -1812.61180985669875554 293.31661882168685906 ) ( 404.63242807195160822 -1696.09174007488900315 211.96202895796943722 ) rock4_2 -3.78198003768920898 21.7248992919921875 349.865997314453125 0.9932439923286438 0.99966299533843994
        ...
        TEST(BrushNodeTest, moveEdgesFail_2361) {
...
( -5764.7302805002028 494 1030 ) ( -5734.7302804990195 638 1030 ) ( -5734.7302804990386 722 1030 ) so_b4b -33.27 6 -0 1 1
        ...
        TEST(BrushNodeTest, loadBrushFail_2361) {
...
( -5772.7302795053893 732 1112 ) ( -5737.730280499567 649 1112 ) ( -5730.7302804970022 574 1112 ) so_b4b -37.27 6 -0 1 1
        ...
        TEST(BrushNodeTest, loadBrushFail_2491) {
        ...
        TEST(BrushNodeTest, loadBrushFail_2686) {
