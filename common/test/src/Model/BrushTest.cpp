...
namespace TrenchBroom {
    namespace Model {
        ...
        TEST(BrushTest, resizePastWorldBounds) {
            ...
            Brush brush1 = builder.createBrush_(std::vector<vm::vec3>{vm::vec3(64, -64, 16), vm::vec3(64, 64, 16), vm::vec3(64, -64, -16), vm::vec3(64, 64, -16), vm::vec3(48, 64, 16), vm::vec3(48, 64, -16)}, "texture");
        ...
        TEST(BrushTest, moveVertex) {
            ...
            Brush brush = builder.createCube_(64.0, "left", "right", "front", "back", "top", "bottom");
        ...
        TEST(BrushTest, moveTetrahedronVertexToOpposideSide) {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = builder.createBrush_(points, "some_texture");
        ...
        TEST(BrushTest, moveVertexInwardWithoutMerges) {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = builder.createBrush_(oldPositions, "texture");
        ...
        TEST(BrushTest, moveVerticesPastWorldBounds) {
            ...
            Model::Brush brush = builder.createCube_(128.0, "texture");
        ...
        TEST(BrushTest, movePointRemainingPolygon) {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = builder.createBrush_(vertexPositions, Model::BrushFaceAttributes::NoTextureName);
        ...
        TEST(BrushTest, removeSingleVertex) {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = builder.createCube_(64.0, "asdf");
            ...
            for (size_t i = 0; i < 6; ++i) {
                for (size_t j = i + 1; j < 7; ++j) {
                    for (size_t k = j + 1; k < 8; ++k) {
                        ...
                        Brush brush = builder.createBrush_(vertices, "asdf");
        ...
        TEST(BrushTest, moveEdgeRemainingPolyhedron) {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = builder.createCube_(128, Model::BrushFaceAttributes::NoTextureName);
        ...
        TEST(BrushTest, cannotMoveFace) {
            const vm::bbox3 worldBounds(4096.0);
            WorldNode world(MapFormat::Standard);

            BrushBuilder builder(&world, worldBounds);
            Brush brush = builder.createCuboid_(vm::vec3(128.0, 128.0, 32.0), Model::BrushFaceAttributes::NoTextureName);
        ...
        TEST(BrushTest, movePolygonRemainingPolygon) {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = builder.createCube_(128.0, Model::BrushFaceAttributes::NoTextureName);
        ...
        TEST_P(UVLockTest, moveFaceWithUVLock) {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = builder.createCube_(64.0, "");
        ...
        TEST(BrushTest, moveVertexFail_2158) {
...
( 1199.73437537143649934 -1850.52292721460958091 299.11555748386712139 ) ( 1195.3323608207340385 -1812.61180985669875554 293.31661882168685906 ) ( 404.63242807195160822 -1696.09174007488900315 211.96202895796943722 ) rock4_2 -3.78198003768920898 21.7248992919921875 349.865997314453125 0.9932439923286438 0.99966299533843994
        ...
        TEST(BrushTest, removeVertexWithCorrectTextures_2082) {
...
( -5764.7302805002028 494 1030 ) ( -5734.7302804990195 638 1030 ) ( -5734.7302804990386 722 1030 ) so_b4b -33.27 6 -0 1 1
        ...
        TEST(BrushTest, moveFaceFailure_1499) {
            ...
            BrushBuilder builder(&world, worldBounds);
            Brush brush = builder.createBrush_(points, "asdf");
        ...
        TEST(BrushTest, subtractCuboidFromCuboid) {
            ...
            BrushBuilder builder(&world, worldBounds);
            const Brush minuend = builder.createCuboid_(vm::bbox3(vm::vec3(-32.0, -16.0, -32.0), vm::vec3(32.0, 16.0, 32.0)), minuendTexture);
            const Brush subtrahend = builder.createCuboid_(vm::bbox3(vm::vec3(-16.0, -32.0, -64.0), vm::vec3(16.0, 32.0, 0.0)), subtrahendTexture);
        ...
        TEST(BrushTest, subtractDisjoint) {
            ...
            BrushBuilder builder(&world, worldBounds);
            const Brush brush1 = builder.createCuboid_(brush1Bounds, "texture");
            const Brush brush2 = builder.createCuboid_(brush2Bounds, "texture");
