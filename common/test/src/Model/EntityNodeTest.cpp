...
namespace TrenchBroom {
    namespace Model {
        ...
        TEST_F(EntityNodeTest, defaults) {
        ...
        TEST_F(EntityNodeTest, originUpdateWithSetAttributes) {
        ...
        TEST_F(EntityNodeTest, originUpdateWithAddOrUpdateAttributes) {
            const vm::vec3 newOrigin(10, 20, 30);
            const vm::bbox3 newBounds(newOrigin - (EntityNode::DefaultBounds.size() / 2.0),
                                      newOrigin + (EntityNode::DefaultBounds.size() / 2.0));
        ...
        TEST_F(EntityNodeTest, originUpdateInWorld) {
        ...
        TEST_F(EntityNodeTest, requiresClassnameForRotation) {
            m_world->defaultLayer()->addChild(m_entity);
        ...
        TEST_F(EntityNodeTest, rotateAndTranslate) {
            m_world->defaultLayer()->addChild(m_entity);
        ...
        TEST_F(EntityNodeTest, rotationMatrixToEulerAngles) {
        ...
        TEST_F(EntityNodeTest, rotationMatrixToEulerAngles_uniformScale) {
            const auto roll = vm::to_radians(12.0);
            const auto pitch = vm::to_radians(13.0);
            const auto yaw = vm::to_radians(14.0);
        ...
        TEST_F(EntityNodeTest, rotationMatrixToEulerAngles_nonUniformScale) {
        ...
        TEST_F(EntityNodeTest, rotationMatrixToEulerAngles_flip) {
